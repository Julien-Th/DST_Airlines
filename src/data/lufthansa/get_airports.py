...
url = "https://api.lufthansa.com/v1/mds-references/airports?LHoperated=1"
...
if response.status_code == 200:
    ...
    with open("/home/ubuntu/DST_Airlines/data/lufthansa/airports.json", "w", encoding="utf-8") as json_file:
        json.dump(airports_data, json_file, indent=4, ensure_ascii=False)
    print("Les airports ont été enregistrés dans 'airports.json'.")
else:
